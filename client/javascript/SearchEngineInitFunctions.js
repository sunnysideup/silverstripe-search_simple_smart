...
var SearchEngineInitFunctions = {
   ...
   * @var string
   */
  formInputSelector: 'SearchEngineBasicForm_Sunnysideup_SearchSimpleSmart_Forms_SearchEngineBasicForm_SearchEngineKeywords',

  /**
   * keyword box selector
   * @var string
   */
  formInputName: 'SearchEngineKeywords',
   ...
   */
  init: function () {
    SearchEngineInitFunctions.formInputSelector = SearchEngineInitFunctions.formSelector + '_' + SearchEngineInitFunctions.formInputName
